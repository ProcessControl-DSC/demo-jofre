# Part of Odoo. See LICENSE file for full copyright and licensing details.
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'pc_fashion_matrix/static/src/js/fashion_matrix_hook.js',
            'pc_fashion_matrix/static/src/js/fashion_purchase_field.js',
            'pc_fashion_matrix/static/src/js/fashion_sale_field.js',
